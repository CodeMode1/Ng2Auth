...
export class SignupComponent implements OnInit {
    ...
    onSignup() {
        //pass the form value as the signupUser method expects a user with email, password, confirm password which is the value of the form
    ...
    ngOnInit(): any {
        ...
        this.myForm = this.fb.group({
            ...
            // control, firebase requires 6 digits pswd
